...
using App_forthe_MaquinaML.Model;

namespace App_forthe_MaquinaML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Enrique\source\repos\Mi-primer-machin\App_forthe_Maquina\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\Enrique\AppData\Local\Temp\MLVSTools\App_forthe_MaquinaML\App_forthe_MaquinaML.Model\MLModel.zip";
